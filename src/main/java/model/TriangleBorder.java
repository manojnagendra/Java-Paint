...
public class TriangleBorder extends PaintCanvasBase implements Geometry {
    ...
    public TriangleBorder(GeometryConfig geometryConfig, int a1, int b, int Coord, int Coord1)
    {
        ...
        this.Coord2[0] = a1-10;
        this.Coord2[1] = Coord+10;
        this.Coord2[2] = a1-10;
        this.Coord3[0] = b-10;
        this.Coord3[1] = Coord1-10;
        this.Coord3[2] = Coord1+10;
