...
public class EllipseBorder extends PaintCanvasBase implements Geometry {
    ...
    public EllipseBorder(GeometryConfig geometryConfig, int Coord, int Coord1, int ShapeWidth1, int ShapeHeight1)
    {
        this.border = Coord;
        this.border1 = Coord1;
    ...
    public void draw(Graphics graph)
    {
        ...
        graphics2D.drawOval(border - 5, border1 - 5, ShapeWidth1 + 10, ShapeHeight1 + 10);
    }
